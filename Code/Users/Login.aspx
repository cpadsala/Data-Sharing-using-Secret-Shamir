                ...
                <div class="main">
                    <div class="header">
                        <div class="header-bottom">
                            <h2>
                                Data Security Using Shamir Secret Sharing Algorithm</h2>
                        </div>
                        <div class="content">
                                ...
                                <div class="row1">
                                    ...
                                    <table class="style1">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                                    ControlToValidate="txtUsername" ErrorMessage="Username Required"></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="style2">
                                            ...
                                            <td class="style3">
                                                ...
                                                <asp:TextBox ID="txtPassword" runat="server" Height="24px" 
                                                    Width="149px" TextMode="Password"></asp:TextBox>
                                            </td>
                                            <td>
                                                &nbsp;
                                        ...
                                        <tr>
                                            ...
                                            <td class="style3">
                                                &nbsp;
                                                <asp:Button ID="btnLogin" runat="server" Height="25px" Text="Login" 
                        ...
                        <div class="footer">
                            ...
                            <p>
                                &copy; Copyright 2010. Designed by <a target="_blank" href="#">htmltemplates.net</a><br>
                                <!--DO NOT Remove The Footer Links-->
                            </p>
                            <ul>
                            </ul>
