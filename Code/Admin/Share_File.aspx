                    ...
                    <div class="content">
                        <table class="style1" cellpadding="5" cellspacing="5">
                            ...
                            <tr>
                                ...
                                <td class="style3">
                                    <asp:DropDownList ID="ddlfile_name" runat="server" AppendDataBoundItems="true" 
                                        DataSourceID="SqlDataSource2" DataTextField="file_name" 
                                        DataValueField="file_id" Width="200px">
                            ...
                            <tr>
                                ...
                                <td class="style3">
                                    <asp:DropDownList ID="ddlcloud_id" runat="server" Width="200px">
                                        <asp:ListItem Value="0">Select Cloud</asp:ListItem>
                                        <asp:ListItem Value="1">Cloud1</asp:ListItem>
                            ...
                            <tr>
                                ...
                                <td class="style3">
                                    <asp:Button ID="btnShare" runat="server" Height="25px" Text="Share" 
